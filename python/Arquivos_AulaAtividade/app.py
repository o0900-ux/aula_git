...
class TelaPerfil(BoxLayout):
    def __init__(self, email, **kwargs):
        ...
        self.deslogar = Button(text="Deslogar", background_color=get_color_from_hex('#ff0000'), size_hint=(None, None), width=380, height=50, )
...
class Telalogin(BoxLayout):
    def __init__(self, **kwargs):
        ...
        self.login = Button(text="Login", background_color=get_color_from_hex('#ff0000'), size_hint=(None, None), width=410, height=50, )
        self.login.bind(on_press=self.Login)
        self.add_widget(self.login)

        self.google_login = Button(text="Continuar com o Google", background_color=get_color_from_hex('#ff0000'), size_hint=(None, None), width=410, height=50, )
        self.google_login.bind(on_press=self.Login)
        self.add_widget(self.google_login)

        self.enviar = Button(text="Não tem conta? Cadastre-se", color=(0, 0, 0.2, 1), bold=True, font_size=16, background_color=(1, 1, 1, 0), size_hint_y=None, height=50)
